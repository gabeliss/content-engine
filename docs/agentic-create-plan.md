...
The agentic Create surface should not require the user to pick brand, platform,
...
- resolve referenced creative assets/personas/artifacts
...
- Add tools for resolving creative assets, personas, and artifacts into model
  reference payloads.
