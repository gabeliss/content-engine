...
export function createWorkflowGraphFromTemplate(templateId: WorkflowTemplateId): WorkflowGraph {
  return structuredClone(getWorkflowTemplate(templateId).graph);
}
